...
{
    public partial class DebtorGroupListFrm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void gridCreditor_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                var frmCurrencies = new DebtorListFrm(_dataListTotal.ElementAt(e.RowIndex).CurrenyId, _dataListTotal.ElementAt(e.RowIndex).GroupId);
                frmCurrencies.ShowDialog();
