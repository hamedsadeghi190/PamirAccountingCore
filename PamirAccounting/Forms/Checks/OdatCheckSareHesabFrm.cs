...
namespace PamirAccounting.Forms.Checks
{
    public partial class OdatCheckSareHesabFrm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void SaveNew()
        {
            ...
            currentCheque.Status = (int)Settings.ChequeStatus.OdatSareHesab;
        ...
        {
            txtDesc.Text = $"{Messages.Odat } -چک به شماره   {currentCheque.ChequeNumber}   -به مبلغ {currentCheque.Amount} {"-تومان"} - تاریخ عودت  {txtOdatDate.Text} ";
        }
