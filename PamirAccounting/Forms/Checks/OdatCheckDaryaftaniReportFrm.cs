    ...
    public partial class OdatCheckDaryaftaniReportFrm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == dataGridView1.Columns["btnRowEdit"].Index && e.RowIndex >= 0)
            {
                ...
                var roleId = unitOfWork.UserInRoleServices.FindFirstOrDefault(x => x.Role.Code == (int)Permission.DeleteOdatDaryafti && x.UserId == CurrentUser.UserID);
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            var data = new UnitOfWork().ChequeServices.GetAllReceivOdat();
        ...
        private void OdatCheckDaryaftaniReportFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
           
        }

        private void OdatCheckDaryaftaniReportFrm_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.F7)
            {
                if (dataGridView1.SelectedRows.Count > 0)
                {
                    ...
                    if (roleId != null || adminRole != null)
                    {
                        ...
                        var frm = new OdatCheckDaryaftaniFrm(0, dataList.ElementAt(rowIndex).Id);
                        frm.ShowDialog();
                        LoadData();
                    }
                }
